...
module SimilarityEstimators
  module Cooccurrence
    ...
    def self.load_similarities_into_redis
      open('/Users/Adam/knn-rec/item_similarities_out/similarity-matrix/part-00000', 'r') { |f|
        f.readlines.each do |line|
          ...
          sme_ids.each do |similarity|
            ...
            $redis.zadd "sme_similarity:#{sme_id.to_s}", sim.to_i, similar_sme_id.to_s
          end
        end
      }
    end
